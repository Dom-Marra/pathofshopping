  ...
  describe('Component HTML', () => {
    ...
    describe('Mod Component', () => {
      ...
      it('has the correct number of mod components', () => {
        ...
        expect(fixture.debugElement.queryAll(By.css('item-mod')).length).toEqual(2);
      });

      it('should set the mod input correctly', () => {
        let modComps = fixture.debugElement.queryAll(By.css('item-mod'));
